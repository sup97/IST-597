...
KR <- tokens(Btxt, remove_puct=T, remove_numbers=T, remove_symbols=T, remove_url=T) %>%
    tokens_remove("\\p{P}", valuetype = "regex", padding = TRUE) %>%
    tokens_remove(stopwords("english"), padding  = TRUE) %>%
    tokens_remove(delete, padding  = TRUE) %>%
    tokens_remove(replace_reg, padding  = TRUE) %>%
...
CHS <- tokens(Ctxt, remove_puct=T, remove_numbers=T, remove_symbols=T, remove_url=T) %>%
    tokens_remove("\\p{P}", valuetype = "regex", padding = TRUE) %>%
    tokens_remove(stopwords("english"), padding  = TRUE) %>%
    tokens_remove(delete, padding  = TRUE) %>%
    tokens_remove(replace_reg, padding  = TRUE) %>%
...
PA <- tokens(Dtxt, remove_puct=T, remove_numbers=T, remove_symbols=T, remove_url=T, remove_twitter=T) %>%
    tokens_remove("\\p{P}", valuetype = "regex", padding = TRUE) %>%
    tokens_remove(stopwords("english"), padding  = TRUE) %>%
    tokens_remove(delete, padding  = TRUE) %>%
    tokens_remove(replace_reg, padding  = TRUE) %>%
