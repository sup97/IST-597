...
delete <- c("http", "https", "southkorea", "korea", "koreantravel", "infohttp", "status", "=") #remove unrelevant words
...
delete <- c("http", "https", "charleston", "explorechs", "us", "p", "status") #remove unrelevant words
